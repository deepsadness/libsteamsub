...
public class MainActivityE3 extends Activity implements
        OnClickListener,
        RtspClient.Callback,
        Session.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(MainActivityE3.this);
    ...
    private void logError(final String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityE3.this);
