 ...
 */
public class MainActivityE2 extends Activity implements OnClickListener, Session.Callback, SurfaceHolder.Callback {

	private final static String TAG = "MainActivityE2";
	...
	private void logError(final String msg) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityE2.this);
